...
from users.views import PhoneNumberCode, PhoneNumberCodesCode, PhoneNumberSomeoneInvite, PhoneNumberList, logout_view, \
    PhoneNumberCodeAPIView, PhoneNumberCodesCodeAPIView, PhoneNumberSomeoneInviteAPI, PhoneNumberListAPI
...
urlpatterns = [
    ...
    path("api/phone_number/code/", PhoneNumberCodesCodeAPIView.as_view(), name="api_code"),
    path("api/phone_number/code/invite/", PhoneNumberSomeoneInviteAPI.as_view(), name="api_code"),
